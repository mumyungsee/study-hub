...
order: 0
track: 필수
description: "GitHub 계정을 만들고, git과 GitHub CLI를 설치한 뒤 VS Code에서 작업 폴더를 엽니다."
status: 공개
---
...
1. VS Code를 실행합니다.
2. 시작 화면에서 `폴더 열기` (영문: `Open Folder`)를 찾습니다.
3. 메뉴에서 찾는다면 `파일` → `폴더 열기...` (영문: `File` → `Open Folder...`)를 선택합니다.
