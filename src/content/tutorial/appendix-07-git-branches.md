...
반대로 GitHub에 있는 내용을 내 컴퓨터로 가져올 때는 `git pull`입니다. 혼자 작업하면 거의 쓸 일이 없지만, 컴퓨터 두 대를 오갈 때 필요합니다 — 노트북에서 push하고 데스크탑에서 이어 받을 때. 팀으로 작업할 때는 더 자주 씁니다. 다른 사람이 push한 내용을 내 컴퓨터에 반영할 때 pull합니다.
